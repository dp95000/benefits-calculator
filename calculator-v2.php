<?php 
/*template name: Calculator V2 Updated*/
get_header(); ?>
...
@media (min-width:1024px) {
	...
	#calculator input[type=text],#calculator textarea,#calculator input[type=number], input[type=tel], input[type=email] {width: 85%;}
...
<div class="container-wrap">
	...
	<div class="container main-content">
		...
		<em><p>* Indicates Required Fields</p></em>
			...
			<p class="label-title in-the-line"><strong>Enter Average Payroll Burden %</strong>
			...
			<div class="divider-wrap">
				<div class="divider-1">
					<label>Full Time*</label><br>
					<div class="input-icon">
					<input type="number" placeholder=" " class="inputcurrency" value="<?php the_field('avg_payroll_burden_percentage'); ?>" step=".01" id="ft-avg-pay-burden-input" min="7.65" required>
					<i>%</i>
					</div>
				</div>
				<div class="divider-2">
					<label>Part Time</label><br>
					<div class="input-icon">
					<input type="number" placeholder=" " class="inputcurrency" value="<?php the_field('avg_payroll_burden_percentage'); ?>" step=".01" id="pt-avg-pay-burden-input" min="7.65">
					<i>%</i>
					</div>
				</div>
			</div>
	...
	// *************  Variables & Inputs *********************** //
				...
				//SCROLL TO BEGINNING OF RESULTS
				function scrollWin() {
